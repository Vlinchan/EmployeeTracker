...
import com.example.employeetracker.viewmodels.PasswordUpdateState
...
fun ChangePasswordScreen(
    ...
    val passwordUpdateState by passwordViewModel.passwordUpdateState.collectAsState()
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Manage your password to keep your account secure.",
            ...
            Button(
                onClick = { passwordViewModel.updatePassword(currentPassword, newPassword, confirmPassword) },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(50.dp),
